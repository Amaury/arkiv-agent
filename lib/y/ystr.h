...
/**
 * @function	ys_create
 *		Create a new empty ystring, defining the size of its buffer.
 *		Pretty much the same as callin ys_new("") and ys_resize().
 * @param	size	Size of the string's buffer.
 * @return	A pointer to the created ystring.
 */
